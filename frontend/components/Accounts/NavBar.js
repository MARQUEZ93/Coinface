...
class NavBar extends React.Component {
  ...
  renderSvg(pathArg) {
    return (
      <svg className="svgNavAccounts" width="16" height="16" fill="#1652f0" viewBox="0 0 16 16">
        <path d={pathArg}> </path>
      </svg>
    );
  }
  ...
  render() {
    ...
    return (
      <div className="navBarAccounts">
        <ul className="unorderedListNavBarAccounts">
          <li className="listItemNavBarAccounts" onClick={this.dashboardPush}>
          ...
          <li className="listItemNavBarAccounts" onClick={this.accountsPush}>
